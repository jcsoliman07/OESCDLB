...
<div class="container my-5">
    <h3 class="display-1"> LIST OF NEW ENROLLEES SECONDARY EDUCATION </h3>
    ...
    <?php
      ...
      $query = "SELECT * FROM tbl_bsestudent ORDER BY id";
    ...
    <table class="table table-bordered">
      ...
      <tbody style="background-color:#fff;">
        <?php
          require 'db_conn.php';
          $i = 0;
          $query = mysqli_query($conn, "SELECT * FROM tbl_bsestudent ORDER BY id") or die(mysqli_error());
 ...
 <!--     <td><?php echo $fetch['fname']?></td>
          ...
          <td>
             <a href="viewbse.php?id=<?=$rows['id']?>" class="btn btn-primary my-5"><span class="fas fa-eye"></span> View </a>
            ...
            <a href="deletebse.php?id=<?=$rows['id']?>" class="btn btn-danger my-5"><span class="fas fa-trash-alt"></span> Delete </a>
            <!-- <button type="button" class="btn btn-success" data-toggle="modal" data-target="#form_modal"><span class="glyphicon glyphicon-plus"></span> Add user</button> -->
          </td>
        </tr>
        <?php
          include 'confirm_bse.php';
          }
        ?>
      </tbody>
    </table>
