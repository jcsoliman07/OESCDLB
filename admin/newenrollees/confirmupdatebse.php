<?php
	...
	if(isset($_POST['Add'])){
		...
		$sql = "INSERT INTO `tbl_approvalbse` (fname,lname,mname,suffix,address,bdate,bplace,religion,gender,email,nationality,cstat,mnum,guardianname,guardiannumber,goccupation,gaddress,requirement) VALUES ('$fname', '$lname', '$mname', '$suffix', '$address', '$bdate', '$bplace', '$religion', '$gender', '$email', '$nationality', '$cstat', '$mnum', '$guardianname', '$guardiannumber', '$goccupation', '$gaddress', '$fileNameNew')";
