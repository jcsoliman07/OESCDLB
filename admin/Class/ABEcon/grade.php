...
<body>
	...
	<br>
	<h4 class="text-center">COLLEGE DEPARTMENT GRADING</h4>
	<br>
	<br>
	...
	<div class="row">
		<table id="myTable" class="table table-bordered table-striped" style="column-span: 100px;">
			...
			<tbody>
					    ...
					    $subj_code = $_GET['subj_code'];
					  	...
					  	while($result2 = $query1->fetch_assoc()){
							...
							"<tr>
								...
								<td>".$result2['lname']. ", " .$result2['fname']."</td>	

								<td>".$result2['student_subj_year']."</td>

								<td>".$result2['prelim']."</td>

								<td>".$result2['midterm']."</td>

								<td>".$result2['prefi']."</td>

								<td>".$result2['final']."</td>

								<td class='text-center alert-info'>".$total1."</td>

								<td class='text-center alert-info'>".$remarks."</td>
				...
				<button onclick="window.print()" class="btn btn-primary" id="print-btn"><a class="pr" href="list.php"><span class="glyphicon glyphicon-print"></span> Print</a></button>	
