<div class="modal fade" id="update_modal<?php echo $rows['id']?>" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="POST" action="insertstudentCS.php">
				...
				<div class="modal-body">
					...
					<div class="col-md-8">
						<div class="form-group">
				            ...
				            <input type="hidden" name="myYear" value="<?php echo $rows['year']?>"/>
				...
				<div class="modal-footer">
					<button name="Add" class="btn btn-primary"><span class="fas fa-user-check"></span> Confirm </button>
