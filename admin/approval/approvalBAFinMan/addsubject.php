				...
				if ($result3) {
					...
					foreach($_POST['subj_code'] as $key => $value){
						...
						if (in_array($_POST['subj_code'][$key],$checked_array)) {
							...
							if ($result5) 
							{
								echo "<script type='text/javascript'>alert('Successfully Added!');window.location.href='approvalbafinman.php'</script>";
							}
							else
							{
								echo "<script type='text/javascript'>alert('Unsuccessfully Added!');window.location.href='approvalbafinman.php'</script>";
							}
						}
					}
				}else{
					echo "<script type='text/javascript'>alert('Unable to add!');window.location.href='approvalbafinman.php'</script>";
				}
			}else{
				echo "<script type='text/javascript'>alert('Error!');window.location.href='approvalbafinman.php'</script>";
			}
