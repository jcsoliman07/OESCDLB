			...
			<div class="col-sm-12">
				...
				<h2><span class="fas fa-clipboard"></span> Subject List </h2>
		       	...
		       	<br/>
		       		...
		       		<table class="table table-sm table-bordered table-hover">
		       			...
		       			<?php
		       				...
		       				while($result1 = mysqli_fetch_array($query1)){
				       			...
				       			$query4 = mysqli_query($conn,"SELECT * FROM tbl_subjects WHERE `subj_year`='$year' AND `subj_semester`='$semester' AND `subj_course`='$course'");
				       	...
				       	<?php
				       			...
				       			$query6 = mysqli_query($conn,"SELECT * FROM tbl_subjects WHERE `subj_year`!='$year' AND `subj_semester`='$semester' AND `subj_course`='$course'");
				       	...
				       	<?php				
				       			...
				       			$query7 = mysqli_query($conn, "SELECT * FROM tbl_subjects WHERE `subj_year`='$year' AND `subj_semester`='$semester' AND `subj_course`='$course'");
				       	...
				       	<?php
				       			...
				       			// }
				       			$query5 = mysqli_query($conn, "SELECT * FROM tbl_subjects WHERE `subj_year`='$year' AND `subj_semester`='$semester' AND `subj_course`='$course'");
				       			while ($result5 = mysqli_fetch_array($query5)) {
				       				// $none = "None";
				       				if ($result5['subj_prereq'] == 'None') {


				       			// $query8 = mysqli_query($conn, "SELECT * FROM tbl_approvalstudent WHERE `fname` = '$fname', AND `mname` = '$mname', AND `lname`='lname'");

				       			// while ($result8 = mysqli_fetch_array($result8)) 
		       		...
		       		<button onclick="checker()" name='Save' class='btn btn-warning'><span class='glyphicon glyphicon-save'></span> Save</button>
