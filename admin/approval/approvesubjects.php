	...
	<div class="container">
		...
		<div class="wrapper">
		 	...
		 	if (isset($_GET['id'])) {
		 		...
		 		$query = mysqli_query($conn, "SELECT * FROM tbl_approvalcs WHERE id=$Id") or die(mysqli_error());
		...
		<h2><span class="fas fa-clipboard"></span> Subject List </h2>
       	...
       	<table class="table table-striped table-bordered">
       		...
       		<?php
       			...
       			$q = mysqli_query($conn, "SELECT * FROM tbl_approvalcs WHERE id=$Id") or die(mysqli_error());
	       			...
	       			while ($rows = mysqli_fetch_array($sql)) {
	       				...
	       				if ($rows['sem_set']==1) {
	       					...
	       					while ($fetch = mysqli_fetch_array($query)) {
	       						$Id = $_GET['id'];
			                    $l = mysqli_query($conn, "SELECT * FROM `tbl_approvalcs` WHERE `id`='$Id'") or die (mysqli_error());
