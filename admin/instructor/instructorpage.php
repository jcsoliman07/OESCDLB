...
<head>
  ...
  <title>CDLB - Faculty and Staff</title>
...
<body>
          ...
          <li class="menu-item">
           ...
           <li class="menu-item">
            ...
            <ul class="sub-menu">
              ...
              <li class="sub-item"><a href="../../instructor.php">Faculty</a></li>
            </ul>
          </li>
  ...
  <section class="section-ins-head">
      <h1>School Faculty and Staff</h1>
  ...
  <?php
    ...
    <div class="card-ins reveal-ins">
      <div class="bg_img">
        ...
        <span><?php echo $result['ins_description']?></span>
      </div>
