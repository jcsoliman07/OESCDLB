        ...
        <table id="myTable" class="table table-bordered table-striped">
          ...
          <tbody style="font-size: 14px;">
            <?php
              ...
              $sql = "SELECT * FROM tbl_student WHERE `course`='$course' ORDER BY id ASC";
              ...
              ?><tr>
                  ...
                  <td>
                    <a href='../../../college/studentbee/info.php?id=<?php echo $rows['id']?>' type='button' name='button' id='button' class='btn btn-info btn-sm' data-toggle='tooltip' data-placement='top' title='View Student Information'><span class='fas fa-list-alt'></span></a>
