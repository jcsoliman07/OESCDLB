          ...
          <tbody style="font-size: 14px;">
            <?php
              ...
              ?><tr>
                  ...
                  <td>
                    <a href='../../../college/studentbsedsci/info.php?id=<?php echo $rows['id']?>' type='button' name='button' id='button' class='btn btn-info btn-sm' data-toggle='tooltip' data-placement='top' title='View Student Information'><span class='fas fa-list-alt'></span></a>
