            ...
            <?php
              ...
              while($rows = $query->fetch_assoc()){
               ?><tr>
                  ...
                  <td>
                    <a href='../../../college/studentcs/info.php?id=<?php echo $rows['id']?>' type='button' name='button' id='button' class='btn btn-info btn-sm' data-toggle='tooltip' data-placement='top' title='View Student Information'><span class='fas fa-list-alt'></span></a>
