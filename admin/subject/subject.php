...
<!--     <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.2/dist/umd/popper.min.js" integrity="sha384-IQsoLXl5PILFhosVNubq5LC7Qb9DXgDA9i+tQ8Zj3iwWAwPtgFTxbJ8NT4GN1R8p" crossorigin="anonymous"></script>
  ...
  <script type="text/javascript">
    ...
    $(document).on('submit', '#addsubject', function(e) {
      ...
      if (subj_code != '' && subj_description != '' && subj_unit != '' && subj_prereq != '' && subj_course != '' && subj_year != '' && subj_semester != '') {
        $.ajax({
          url: "addsubj.php",
          type: "post",
          data: {
    ...
    $(document).on('submit', '#updateSubject', function(e) {
      ...
      if (subj_code != '' && subj_description != '' && subj_unit != '' && subj_prereq != '' && subj_course != '' && subj_semester != '' && subj_year != '') {
        $.ajax({
          url: "updatesubj.php",
          type: "post",
          data: {
          ...
          success: function(data) {
            ...
            if (status == 'true') {
              ...
              row.row("[id='" + trid + "']").data([id, subj_code, subj_description, subj_unit, subj_prereq, subj_course, subj_semester, subj_year, button]);
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Update Subjects</h5>
        </div>
  ...
  <div class="modal fade" id="addsubjectModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addsubject" action="post">
            <div class="mb-3">
                  <label class="form-label">Subject: </label>
                ...
                <div class="mb-3">
                  <label class="form-label">Description: </label>
                  <input type="text" name="subj_description" id="subj_description" class="form-control" required>
                </div>

                <div class="mb-3">
                  <label class="form-label">Unit: </label>  
                  <input type="text" name="subj_unit" id="subj_unit" class="form-control" required>
                </div>
                
                <div class="mb-3">
                  <label class="form-label">Pre-Requisite: </label>
                  <input type="text" name="subj_prereq" id="subj_prereq" class="form-control" required>
                </div>

                <div class="mb-3">
                  <label class="form-label">Course: </label>
                  <input type="text" name="subj_course" id="subj_course" class="form-control" value="BSCS" readonly>
                </div>
                <!-- <div class="mb-3">
                  <label class="form-label">Course: </label>
                ...
                <div class="mb-3">
                  <label class="form-label">Year: </label>
                  <select name="subj_year" id="subj_year" class="form-control" required>
                ...
                <div class="mb-3">
                  <label class="form-label">Semester: </label>
                  <select name="subj_semester" id="subj_semester" class="form-control" required>
                    <option>--Select--</option>
                    <option value="First"> First</option>
                    <option value="Second"> Second</option>
                  </select>
