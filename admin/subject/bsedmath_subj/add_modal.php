        ...
        <div class="modal-content">
			...
			<form method="POST" action="add.php">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="subj_course" value="Bachelor of Secondary Education">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="subj_major" value="Mathematics">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
