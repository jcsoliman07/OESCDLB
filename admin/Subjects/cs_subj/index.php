    ...
    <div class="row">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-10">
            <table id="subject" class="table table-sm table-bordered table-hover">
              <thead>
                <th>Id</th>
                <th>Subject</th> 
                <th>Description</th>
        ...
        <div class="modal-body">
          <form id="addSubject" action="">
            <div class="mb-3">
                ...
                <div class="mb-3">
                  <label class="form-label">Course: </label>
                  <input type="text" name="subj_course" id="subj_course" class="form-control clear" value="BSCS" readonly>
                </div>
                <!-- <div class="mb-3">
                  <label class="form-label">Course: </label>
