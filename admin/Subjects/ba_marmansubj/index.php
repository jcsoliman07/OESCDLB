        ...
        <div class="modal-body">
          <form id="addSubject" action="">
            <div class="mb-3">
                ...
                <div class="mb-3">
                  <label class="form-label">Course: </label>
                  <input type="text" name="subj_course" id="subj_course" class="form-control clear" value="BSBA" readonly>
                </div>
                <div class="mb-3">
                  <label class="form-label">Major: </label>
                  <input type="text" name="subj_major" id="subj_major" class="form-control clear" value="Marketing Management" readonly>
                </div>
                <!-- <div class="mb-3">
                  <label class="form-label">Course: </label>
