...
<body>
  ...
  <nav>
    <ul>
      ...
      <li>
        <div class="user">
         <?php 
            ...
            $sql = mysqli_query($conn, "SELECT * FROM tbl_instructor WHERE ins_id='$login_id'");
            while ($row = mysqli_fetch_array($sql)) {
          ?>
            <img src="../../../../../../<?php echo $row['ins_image']; ?>">
          <?php

            }
          ?>
          <p style="font-weight: bold; text-align: center; color: white;"><?php echo $_SESSION['username']; ?></p>
        </div>
      </li>
      <br>
      <br>
      ...
      <li>
        <a href="subject.php" target="frame_body">
      ...
      <li>
        <a href="account.php" target="frame_body">
