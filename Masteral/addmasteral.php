		...
		else
		{
			...
			if ($status == $status1) 
			{
				...
				if ($result) {
					...
					echo "<script type='text/javascript'>alert(' Successfully Sent! ');window.location.href='enrollFormmasteral.php'</script>";
				}
				else
				{
					echo "<script type='text/javascript'>alert(' Unsuccessfully Sent! ');window.location.href='enrollFormmasteral.php'</script>";
				}
			}
