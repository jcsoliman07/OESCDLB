...
<body>
		...
		<form  action="confirmNewmasteral.php" method="POST" autocomplete="off" id="form" enctype="multipart/form-data">
		 	<div class="row">
		    	...
		    	<div class="col-sm-8">
					...
					<div class="shadow-none p-3 mb-5 bg-light rounded">
						...
						<div class="form-group row">
							<div class="col-sm-6">
								<label class="form-label" style="font-weight: bold;"><p1 style="color:red"> * </p1> Year: </label>
									<select name="year" id="year" class="custom-select  form-control-sm">
							...
							<div class="col-sm-6">
								<label class="form-label" style="font-weight: bold;"><p1 style="color:red"> * </p1>Major: </label>
								<select name="major" class="custom-select  form-control-sm">
									<option value="">--Select--</option>
								<?php
									include "../db_conn.php";
									$course = 'Master in Management';
									$sql = mysqli_query($conn, "SELECT crse_major FROM tbl_course WHERE crse_description ='$course'");
								...
								<input type="hidden" name="course" id="course" value="Master in Management">
							</div>
