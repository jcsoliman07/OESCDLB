...
<body>
	...
	<form action="addmasteral.php" method="POST" enctype="multipart/form-data">
		<div class="row">
		    	...
		    	<hr class="bg-dark border-5">
		   		...
		   		<div class="shadow-none p-3 mb-5 bg-light rounded">
		   			...
		   			<div class="form-group row">
		   				...
		   				<div class="col-sm-4">
							<input type="text" style="border: none; background: white;" name="course" id="course" class="form-control  form-control-sm" value="<?php echo $course;?>" readonly>
		   		...
		   		<div class="form-group row">
					...
					<div class="form-group row">
						<div class="col-sm-10">
							<!-- <label class="form-label"><p1 style="color:red"> * </p1>  Picture (2x2): </label> -->
