<?php
	...
	if (isset($_GET['id'])) {
		$update_id = $_GET['id'];
		$sql_update = mysqli_query($conn, "UPDATE `tbl_masteralold` SET `notif`=1 WHERE `id`='$update_id'");
	}
?>
...
<?php 
$sql = mysqli_query($conn, "SELECT * FROM tbl_masteralold WHERE id='$update_id'");
