...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>CDLB - Basic Education</title>
   ...
   <header>
    ...
    <section class="section-be-content">
      <div class="be-content">
        <h2>Excellence</h2>
        <h1>Excellence in Academics and Life</h1>
        <img src="image/shs1.jpg" alt="">

        <p><i>O</i>ur basic education academic program offers the most balanced education in Laguna. On one hand, we provide students with education through a quality-assured curriculum. On the other hand, we allow them to experience holistic development through vocational extracurricular activities. In addition, our Senior High School Program offers the unique curriculum. This curriculum features mastery of English, immersion in technology, and network opportunities with employer partners.</p>

      </div>

      <div class="be-content1">
        <h2>Young Minds</h2>
        <h1>Molding Young Minds</h1>

        <div class="be-content1-hs-content">
          <div class="be-content1-hs reveal">
            <img src="image/j1.jpg">
            <h3>Junior High School</h3>
            <a href="Juniorhighpage.php" class="ctn">Read More</a>
          </div>

           <div class="be-content1-hs reveal">
            <img src="image/shs3.jpg">
            <h3>Senior High School</h3>
            <a href="Seniorhighpage.php" class="ctn">Read More</a>
          </div>
