...
<?php
	...
	$query = mysqli_query($conn, "SELECT * FROM tbl_masteralstudent")or die(mysqli_error($conn));
...
<div class="container my5">
		<div class="row">
			<div class="col-sm-4">
				...
				<div class="form-group row">
					<div>
						<!-- <a href="enrollform.php?id=<?=$row['student_id']?>" style="font-size: 16px; font-weight: bold;">Enroll Now</a> -->
						<button class="btn btn-outline-info" data-toggle="modal" type="button" data-target="#update_modal<?php echo $row['student_id']?>"><span class="fas far fa-edit" style=""></span> Enroll Now </button>
