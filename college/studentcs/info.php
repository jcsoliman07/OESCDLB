...
if (isset($_GET['id'])) {
	...
	function validate($data){
		...
		if (mysqli_num_rows($result) > 0) {
			...
			header("Location:../../admin/college/studentCS/index.php");
		}
...
{
	echo "<script type='text/javascript'>alert('Error!');window.location.href='../../admin/college/studentCS/index.php?error=Unsuccessfully Updated!'</script>";
}
?>
