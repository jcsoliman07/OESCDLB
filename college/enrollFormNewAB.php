...
<body>
		...
		<form  action="confirmNewAB.php" method="POST" autocomplete="off" id="form" enctype="multipart/form-data">
		 	<div class="row">
		    	...
		    	<div class="col-sm-8">
					...
					<div class="shadow-none p-3 mb-5 bg-light rounded">
						...
						<div class="form-group row">
							...
							<input type="hidden" name="course" id="course" value="Bachelor of Arts in Economics">
						</div>
