...
if (isset($_GET['id'])) {
	...
	function validate($data){
		...
		if (mysqli_num_rows($result) > 0) {
			...
			header("Location:../../admin/college/studentBAFinman/index.php");
		}
	...
	if ($result) {
		echo "<script type='text/javascript'>alert('Successfully Updated!');window.location.href='../../admin/college/studentBAFinman/index.php?success=Successfully Updated!'</script>";
	}
	else{
		echo "<script type='text/javascript'>alert('Unsuccessfully Updated!');window.location.href='../../admin/college/studentBAFinman/index.php?error=Unsuccessfully Updated!'</script>";
	}
}
else
{
	echo "<script type='text/javascript'>alert('Error!');window.location.href='../../admin/college/studentBAFinman/index.php?error=Unsuccessfully Updated!'</script>";
}
?>
