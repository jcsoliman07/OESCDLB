...
<body>
	...
	<form id="form" action="addCS.php" method="POST" enctype="multipart/form-data">
		<div class="row">
		    	...
		    	<hr class="bg-dark border-5">
		   		...
		   		<div class="shadow-none p-3 mb-5 bg-light rounded">
		   			...
		   			<div class="form-group row">
		   				...
		   				<div class="col-sm-4">
							<input type="text" style="border: none; background: white;" name="mname" id="mname" class="form-control  form-control-sm" value="<?php echo $mname;?>" readonly>
		   				</div>
