...
<body>
		...
		<form  action="confirmNewBA.php" method="POST" autocomplete="off" id="form" enctype="multipart/form-data">
		 	<div class="row">
		    	...
		    	<div class="col-sm-8">
					...
					<div class="shadow-none p-3 mb-5 bg-light rounded">
						...
						<div class="form-group row">
							...
							<input type="hidden" name="course" id="course" value="Bachelor of Science in Business Administration">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							...
							<input type="text" name="mname" minlength="2" required id="mname" class="form-control  form-control-sm" value="N/A">
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							...
							<input type="text" name="mnum" id="mnum" minlength="11" maxlength="11" size="11" class="form-control  form-control-sm" value="N/A">
