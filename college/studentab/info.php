...
if (isset($_GET['id'])) {
	...
	function validate($data){
		...
		if (mysqli_num_rows($result) > 0) {
			...
			echo "<script type='text/javascript'>alert('Error Student cannot found!');window.location.href='../../admin/college/studentAB/index.php'</script>";
		}
	...
	if ($result) {
		echo "<script type='text/javascript'>alert('Successfully Updated!');window.location.href='../../admin/college/studentAB/index.php?success=Successfully Updated!'</script>";
	}
	else{
		echo "<script type='text/javascript'>alert('Unsuccessfully Updated!');window.location.href='../../admin/college/studentAB/index.php?error=Unsuccessfully Updated!'</script>";
	}
}
else
{
	echo "<script type='text/javascript'>alert('Error!');window.location.href='../../admin/college/studentAB/index.php?error=Unsuccessfully Updated!'</script>";
}
?>
				...
				<form method="post" action="info.php" autocomplete="off">
					...
					<div class="form-group row">
						<div class="col-sm-4">
							...
							<input type="date" name="bdate" class="form-control form-control-sm" value="<?=$row['bdate']?>">
						</div>
						<div class="col-sm-4">
