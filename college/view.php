<?php
	...
	if (isset($_GET['id'])) {
		$update_id = $_GET['id'];
		$sql_update = mysqli_query($conn, "UPDATE `tbl_newstudent` SET `notif`=1 WHERE `id`='$update_id'");
	}
?>
...
<?php 
$sql = mysqli_query($conn, "SELECT * FROM tbl_newstudent WHERE id='$update_id'");
		...
		<div class="col-sm-12">
			...
			<form method="post" action="viewSave.php" autocomplete="off">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<label>NOTE: </label><br/>
						<p1 style="font-style: italic; color:red;">This must be filled by the Registrar / Admin</p1>
					</div>
				</div>
				...
				<div class="form-group row">
					<div class="col-sm-3">
						...
						<input type="hidden" name="a_year" class="form-control" value="<?=$result['academic_year']?>" readonly>
					</div>
					<div class="col-sm-3">
