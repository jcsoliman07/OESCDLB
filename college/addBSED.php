...
{		
		...
		if ($check1 == false || $check2 == false || $check3 == false || $check4 == false || $check5 == false || $check6 == false) {
			echo "<script type='text/javascript'>alert('Sorry, One or more file is fake. Only JPEG, JPG and PNG are allowed');window.location.href='enrollFormBSED.php'</script>";
		}
			...
			echo "<script type='text/javascript'>alert('Sorry, One or more file size is too large');window.location.href='enrollFormBSED.php'</script>";
		}
		...
		else
		{
			...
			echo "<script type='text/javascript'>alert('Sorry, One or more file name already exist in our database, give your files a unique name');window.location.href='enrollFormBSED.php'</script>";
			}
				...
				echo "<script type='text/javascript'>alert('Sorry, One or more file is not an image. Only JPEG, JPG and PNG are allowed');window.location.href='enrollFormBSED.php'</script>";
				...
				if ($result) {
					...
					echo "<script type='text/javascript'>alert(' Successfully Sent! ');window.location.href='enrollFormBSED.php'</script>";
				}
				else
				{
					echo "<script type='text/javascript'>alert(' Unsuccessfully Sent! ');window.location.href='enrollFormBSED.php'</script>";
				}
			}
		}
