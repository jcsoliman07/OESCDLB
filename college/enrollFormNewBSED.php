		    	...
		    	<div class="col-sm-8">
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							...
							<input type="text" name="mname" minlength="2" maxlength="15" size="20" required id="mname" class="form-control  form-control-sm" value="N/A">
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group row">
						<div class="col-sm-4">
							...
							<input type="date" name="bdate" id="bdate" class="form-control  form-control-sm"  placeholder="Birthdate" required>
						</div>
						<div class="col-sm-4">
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							...
							<input type="text" name="mnum" id="mnum" minlength="11" maxlength="11" size="11" class="form-control  form-control-sm"  placeholder="Mobile Number" value="N/A">
						</div>
					</div>
					<br/>
