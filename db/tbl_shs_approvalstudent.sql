...
--
-- Table structure for table `tbl_shs_approvalstudent`
--

CREATE TABLE `tbl_shs_approvalstudent` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tbl_shs_approvalstudent`
--
ALTER TABLE `tbl_shs_approvalstudent`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_shs_approvalstudent`
--
ALTER TABLE `tbl_shs_approvalstudent`
