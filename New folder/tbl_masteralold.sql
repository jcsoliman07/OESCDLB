...
--
-- Table structure for table `tbl_masteralold`
--

CREATE TABLE `tbl_masteralold` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tbl_masteralold`
--
ALTER TABLE `tbl_masteralold`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_masteralold`
--
ALTER TABLE `tbl_masteralold`
