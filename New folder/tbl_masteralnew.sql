...
--
-- Table structure for table `tbl_masteralnew`
--

CREATE TABLE `tbl_masteralnew` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tbl_masteralnew`
--
ALTER TABLE `tbl_masteralnew`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_masteralnew`
--
ALTER TABLE `tbl_masteralnew`
