...
--
-- Table structure for table `tbl_jhs_student`
--

CREATE TABLE `tbl_jhs_student` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tbl_jhs_student`
--
ALTER TABLE `tbl_jhs_student`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_jhs_student`
--
ALTER TABLE `tbl_jhs_student`
