...
--
-- Table structure for table `tbl_masteralstudent`
--

CREATE TABLE `tbl_masteralstudent` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tbl_masteralstudent`
--
ALTER TABLE `tbl_masteralstudent`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_masteralstudent`
--
ALTER TABLE `tbl_masteralstudent`
