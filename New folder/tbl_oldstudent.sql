...
--
-- Table structure for table `tbl_oldstudent`
--
...
--
-- Dumping data for table `tbl_oldstudent`
--

INSERT INTO `tbl_oldstudent` (`id`, `notif`, `enrolled_date`, `semester`, `student_status`, `course`, `major`, `student_id`, `year`, `fname`, `lname`, `mname`, `suffix`, `house_street`, `barangay`, `city`, `province`, `bdate`, `bplace`, `religion`, `nationality`, `gender`, `cstat`, `email`, `mnum`, `fathername`, `fathermnum`, `foccupation`, `faddress`, `mothername`, `mothermnum`, `moccupation`, `maddress`, `guardianname`, `guardiannumber`, `goccupation`, `gaddress`, `requirement1`, `requirement2`, `requirement3`, `requirement4`, `requirement5`, `requirement6`) VALUES
(9, 0, '2022-23-05', 'Second', 'Old', 'Bachelor of Science in Computer Science', 'None', '18-3282', 'First', 'Jomar', 'Soliman', 'Coronel', 'N/A', '262', 'Maahas', 'Los Baños', 'Laguna', '2000-09-13', 'Los Baños Laguna', 'Christianity', 'Filipino', 'Male', 'Single', 'jomarsoliman01@gmail.com', '09515234936', 'Emmanuel S. Soliman', '09057153725', 'N/A', 'N/A', 'Marilou C. Soliman', '09057153725', 'N/A', 'N/A', 'Marilou C. Soliman', '09057153725', 'N/A', '', NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Indexes for table `tbl_oldstudent`
--
...
--
-- AUTO_INCREMENT for table `tbl_oldstudent`
--
ALTER TABLE `tbl_oldstudent`
