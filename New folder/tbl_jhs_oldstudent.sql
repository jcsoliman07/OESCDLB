...
--
-- Table structure for table `tbl_jhs_oldstudent`
--

CREATE TABLE `tbl_jhs_oldstudent` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tbl_jhs_oldstudent`
--
ALTER TABLE `tbl_jhs_oldstudent`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_jhs_oldstudent`
--
ALTER TABLE `tbl_jhs_oldstudent`
