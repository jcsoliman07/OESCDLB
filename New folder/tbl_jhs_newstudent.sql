...
--
-- Table structure for table `tbl_jhs_newstudent`
--

CREATE TABLE `tbl_jhs_newstudent` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tbl_jhs_newstudent`
--
ALTER TABLE `tbl_jhs_newstudent`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_jhs_newstudent`
--
ALTER TABLE `tbl_jhs_newstudent`
