...
--
-- Table structure for table `tbl_shs_newstudent`
--

CREATE TABLE `tbl_shs_newstudent` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tbl_shs_newstudent`
--
ALTER TABLE `tbl_shs_newstudent`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_shs_newstudent`
--
ALTER TABLE `tbl_shs_newstudent`
