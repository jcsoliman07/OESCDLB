...
--
-- Table structure for table `tbl_masteralapproval`
--

CREATE TABLE `tbl_masteralapproval` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tbl_masteralapproval`
--
ALTER TABLE `tbl_masteralapproval`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_masteralapproval`
--
ALTER TABLE `tbl_masteralapproval`
