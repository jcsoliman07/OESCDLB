...
<head>
	...
	<title>Registration Form - Basic Education</title>
...
<body>
		...
		<form  action="confirmNewSHS.php" method="POST" autocomplete="off" id="form" enctype="multipart/form-data">
		 	<div class="row">
		    	...
		    	<div class="col-sm-8">
		    		...
		    		<div>
						<h4>
							<span class="badge"><i class='bx bx-book' style="color: white; margin-right: 2px;"></i>
								Senior High School
							</span>
						</h4>
					</div>
					<div class="shadow-none p-3 mb-5 bg-light rounded">
						<br/>
						<div class="form-group row">
							<label class="form-label" style="font-weight: bold;"><p1 style="color:red"> * </p1>Status:</label>
							<div class="col-md-2">
							...
							<div class="col-md-2">
								...
								<label class="form-check-label" for="html">Old</label>
							</div>
							<div class="col-md-2">
								<input type="radio" id="transferee" name="status" value="Transferee">
								<label class="form-check-label" for="html">Transferee</label>
							</div>
						</div>
						
						<div class="form-group row">
							<div class="col-sm-6">
								<label class="form-label" style="font-weight: bold;"><p1 style="color:red"> * </p1>Grade:</label>
								<select name="grade" id="grade" class="custom-select form-control-sm">
							...
							<div class="col-sm-6">
								<label class="form-label" style="font-weight: bold;"><p1 style="color:red"> * </p1> Strand: </label>
									<select name="strand" id="strand" class="custom-select  form-control-sm">
										<option value="">--Select--</option>
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
							...
							<select name="cstat" class="custom-select form-control-sm" required>
			                    <option value="">--Select--</option>
			                    <option value="Divorce"> Single </option>
			                    <option value="Married"> Married </option>
			                    <option value="Seperated"> Widows/er </option>
			                    <option value="Single"> Legally Separated </option>
