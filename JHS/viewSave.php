		...
		if ($result['student_id'] == $student_id) {
				...
				if ($result) {
					...
					if ($result1) {
						...
						echo "<script type='text/javascript'>alert('Unsuccessfully Save!');window.location.href='../admin/newenrolleesJHS/jhs_7/index.php";
					}
