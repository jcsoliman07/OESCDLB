...
<body>
	...
	<form action="addJHS.php" method="POST" enctype="multipart/form-data">
		<div class="row">
		    	...
		    	<hr class="bg-dark border-5">
		   		...
		   		<div class="shadow-none p-3 mb-5 bg-light rounded">
		   			<div class="form-group row">
		   				...
		   				<div class="col-sm-4">
		   					<input type="text" style="border: none; background: white;" name="grade" id="grade" class="form-control  form-control-sm" value="<?php echo $grade;?>" readonly>
...
<!-- 		   				<div class="col-sm-1">
		   				...
		   				<div class="col-sm-4">
							<input type="text" style="border: none; background: white;" name="strand" id="strand" class="form-control  form-control-sm" value="<?php echo $strand;?>" readonly>
		   				</div> -->
