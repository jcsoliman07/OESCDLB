...
{		
		...
		if ($check1 == false || $check2 == false || $check3 == false || $check4 == false || $check5 == false || $check6 == false) {
			echo "<script type='text/javascript'>alert('Sorry, One or more file is fake. Only JPEG, JPG and PNG are allowed');window.location.href='enrollFormjhs.php'</script>";
		}
			...
			echo "<script type='text/javascript'>alert('Sorry, One or more file size is too large');window.location.href='enrollFormjhs.php'</script>";
		}
			...
			echo "<script type='text/javascript'>alert('Sorry, One or more file name already exist in our database, give your files a unique name');window.location.href='enrollFormjhs.php'</script>";
		}
		else
		{
			$status1 = 'New';
			...
			if ($status == $status1) 
			{
				$sql = "INSERT INTO tbl_jhs_newstudent (enrolled_date, student_status, grade, fname, lname, mname, suffix, house_street, barangay, city, province, bdate, bplace, religion, nationality, gender, cstat, email, mnum, fathername, fathermnum , foccupation , faddress, mothername, mothermnum, moccupation, maddress, guardianname, guardiannumber, goccupation, gaddress, requirement1, requirement2, requirement3, requirement4, requirement5, requirement6) VALUES ('$enrolled_date','$status','$grade','$fname','$lname','$mname','$suffix','$house_no','$barangay','$city','$province','$bdate','$bplace','$religion','$nationality','$gender','$cstat','$email','$mnum','$fathername','$fmnum','$foccupation','$foccupaddress','$mothername','$mmnum','$moccupation','$moccupaddress','$guardianname','$gmnum','$goccupation','$goccupaddress','$target_file1','$target_file2','$target_file3','$target_file4','$target_file5','$target_file6')";
				...
				if ($result) {
					...
					echo "<script type='text/javascript'>alert(' Successfully Sent! ');window.location.href='enrollFormjhs.php'</script>";
				}
				else
				{
					echo "<script type='text/javascript'>alert(' Unsuccessfully Sent! ');window.location.href='enrollFormjhs.php'</script>";
				}
			}
			...
			else
			{
				...
				$sql = "INSERT INTO tbl_jhs_oldstudent (enrolled_date, student_status,  grade, fname, lname, mname, suffix, house_street, barangay, city, province, bdate, bplace, religion, nationality, gender, cstat, email, mnum, fathername, fathermnum , foccupation , faddress, mothername, mothermnum, moccupation, maddress, guardianname, guardiannumber, goccupation, gaddress, requirement1, requirement2, requirement3, requirement4, requirement5, requirement6) VALUES ('$enrolled_date','$status1','$grade','$fname','$lname','$mname','$suffix','$house_no','$barangay','$city','$province','$bdate','$bplace','$religion','$nationality','$gender','$cstat','$email','$mnum','$fathername','$fmnum','$foccupation','$foccupaddress','$mothername','$mmnum','$moccupation','$moccupaddress','$guardianname','$gmnum','$goccupation','$goccupaddress','$target_file1','$target_file2','$target_file3','$target_file4','$target_file5','$target_file6')";
